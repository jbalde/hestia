...
import { Send, Bot, CalendarCheck, RotateCcw } from "lucide-react";
        ...
        {messages.map((msg) => (
          <div key={msg.id} className={cn("flex flex-col", msg.role === "user" ? "items-end" : "items-start")}>
            <div className={cn("flex", msg.role === "user" ? "justify-end" : "justify-start")}>
              {msg.role === "assistant" && (
                <div className="bg-indigo-100 p-1.5 rounded-full h-7 w-7 flex items-center justify-center mr-2 shrink-0 mt-1">
